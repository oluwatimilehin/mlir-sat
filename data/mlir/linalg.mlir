// I should ideally allocate AB and AC in the function, but `dealloc` keeps unnecessary operations around after the conversion, and xdsl does not play well with memref.alloca
